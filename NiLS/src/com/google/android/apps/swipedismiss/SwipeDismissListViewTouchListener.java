...
package com.google.android.apps.swipedismiss;
...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
                    ...
                    mDownView.animate()
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    performDismiss(downView, downPosition, finalDismissRight);
                                }
                            });
                } else {
                    // cancel
    ...
    private void performDismiss(final View dismissView, final int dismissPosition, boolean dismissRight)
    {
        Log.d("NiLS+", "SwipeDismissListViewTouchListener:performDismiss pos:"+dismissPosition+",refCount:"+mDismissAnimationRefCount+",pending:"+mPendingDismisses.size());
